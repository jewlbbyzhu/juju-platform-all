...
- **分支**: backup-auto-20260331-210742
- **推送状态**: ✅ 与远程同步，无新提交需要推送
- **工作区问题**: 3个目录（JujuApp_076, JujuApp_fresh, JujuApp_new）显示"modified content"但无.gitmodules配置，不是真正的git submodule，无法用标准git流程提交
...
| 端点 | 状态码 | 响应 |
|------|--------|------|
| `GET /health` | 200 | {"status":"healthy","uptime":14950.43s,...} |
