    ...
    try {
      ...
      if (!packages || packages.length === 0) {
        const defaultPackages = [
          { id: 1, name: '月度会员', description: '享受月度VIP权益', price: 29.99, duration: 1, is_active: 1, is_recommended: 0 },
          { id: 2, name: '季度会员', description: '享受季度VIP权益', price: 79.99, duration: 3, is_active: 1, is_recommended: 1 },
          { id: 3, name: '年度会员', description: '享受年度VIP权益', price: 299.99, duration: 12, is_active: 1, is_recommended: 0 }
        ];
        return success(res, defaultPackages);
      }
